...
export default function B2BPage({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      ...
      {/* ══ Section Header ══ */}
      <section
        style={{ background: "#f8f5f0", paddingTop: 64, paddingBottom: 0 }}>
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p
                className="box-text"
                style={{ marginTop: 14, maxWidth: 600, margin: "14px auto 0" }}>
                {t("b2b.description")}
              </p>
            </div>
          </div>
                ...
                {features.map((f: any, i: number) => (
                  <div
                    ...
                    <div
                      ...
                      <i
                        className={`far ${f.icon}`}
                        style={{ color: "#ead369", fontSize: "1.1rem" }}
                      />
                    </div>
                    <div>
                      <h5
              ...
              <div
                ...
                <div
                  ...
                  <div
                    ...
                    <i
                      className="far fa-file-invoice-dollar"
                      style={{ color: "#ead369", fontSize: "1.1rem" }}
                    />
                  </div>
                  <div>
      ...
      <section
        ...
        style={{ background: "#214137" }}>
        <div className="container">
          <div className="row justify-content-center mb-50">
            <div className="col-lg-7 text-center">
              <span
                className="sub-title text-anime-style-1"
                style={{ color: "#ead369" }}>
                {t("b2b.certsSubtitle")}
              </span>
              <h2
                className="sec-title text-anime-style-2 text-white"
                style={{ marginTop: 8 }}>
                {t("b2b.certsTitle")}
              </h2>
              <p
              ...
              <div key={i} className="col-lg-3 col-md-6">
                <div
                  ...
                  <div
                    ...
                    <i
                      className={`far ${CERT_ICONS[i % CERT_ICONS.length]}`}
...
function Err({ msg }: { msg: string }) {
  return (
    <div
      ...
      style={{ display: "block", fontSize: ".74rem" }}>
      {msg}
    </div>
  );
}
